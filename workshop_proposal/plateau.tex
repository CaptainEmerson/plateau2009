...
Oriented Software and supervised by James Noble and Stuart Marshall. Craig has participated
...
\item \textbf{Robert Biddle} is a Professor of Human-Computer
  Interaction appointed both to the Office of the Dean of Arts and
  Social Sciences and to the School of Computer Science at Carleton
  University, Canada. His research interests are in ``the secret life
  of software'': how software can work in rich and subtle ways with
  human expression and human behaviour. His current projects are on
  computer security, computer games, and agile software development.
  Robert has been on the PC of OOPSLA ('07, '05) and Onward! ('09,
  '08, '07, '06).

\item \textbf{Andrew Black} is a Professor of Computer Science,
...
\item \textbf{Donna Malayeri} is a PhD student in the Computer Science
  ...
  Retroactive Abstraction, Extensibility and Inheritance in
...
\item \textbf{Stuart Marshall} is a Lecturer in the School of
  Engineering and Computer Science, Victoria University of Wellington,
  New Zealand. His research interests are in the area of mobile user
  interfaces, software reuse, and software visualization.
...
\item \textbf{James Noble} is a Professor of Computer Science
  ...
  % James has been chair of DLS ('09), WikiSym ('06), and KoalaPLoP
  % ('02). James has also been on the PC of a range of conferences
  % including POPL ('07), AOSD ('08), WikiSym ('08, '07, '06, '05),
  % VL/HCC ('08, '07, '06), forUSE ('02), and TOOLS Pacific
  % ('02). Finally, James is also a director of the Hillside Group and
  % Foundation Editor-In-Chief of Transactions on Pattern Languages of
  % Programming, ('07-present).
