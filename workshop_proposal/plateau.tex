...
Human Computer Interaction; Software Visualisation and Visual Languages; and the philosophy of Computer Science and Software Engineering. James has been on the PC of OOPSLA ('09, '06, '05, '02, '01) and ECOOP ('09, '08, '07, '05, '01). 

%James has been chair of DLS ('09), WikiSym ('06), and KoalaPLoP ('02). James has also been on the PC of a range of 
%conferences including POPL ('07), AOSD ('08), WikiSym ('08, '07, '06, '05), VL/HCC ('08, '07, '06), forUSE ('02), and TOOLS Pacific ('02). Finally, James is also a director of the Hillside Group and Foundation Editor-In-Chief of Transactions on Pattern Languages of Programming, ('07-present).
