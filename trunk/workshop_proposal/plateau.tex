...
\item \textbf{Caitlin Sadowski} is currently a PhD candidate in the 
  Computer Science Department at UC Santa Cruz where she is advised by Jim Whitehead and Cormac Flanagan. Her PhD is focused on dynamic analyses for detecting concurrency errors. %; she also has a body of research focused on usability and parallel programming.
