...
language community.
\emh{Do we want to alphabetize this list?  If not, why do some people appear at the top?}
...
There was a workshop focused on the Interplay between Usability 
Evaluation and Software Development (I-USED) in 2008, 
and a F/OSS Usability Workshop in 2006.
\emh{how does this related to our proposal? 
how are they related to ``advertisement''?
Also, they don't seem particularly related (no more so than CHI, anyway),
because they seem to be about enabling developers to create more usable software,
whereas our workshop is about creating and evaluating more usable software tools}

We will advertise this workshop by inviting participants of past 
workshops directly, as well as by emailing related mailing lists 
and specific people known to be working in this area. 
In addition we will maintain a website for presenting position 
papers and organizational information. 
...
\emh{To make it as easy as  possible on ourselves and the submitters, I would
argue that we should only have the 4-page submissions.
As a potential submitter, an 8-page workshop paper is a lot of work without a lot of glory}
